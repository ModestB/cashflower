...
import { setTransactionsSaga, deleteTransactionsSaga } from './transactions/transactionsSaga';
...
export function* watchStatistics() {
  yield takeLatest(actionTypes.OVERVIEW_GET_REQUESTED, setOverviewSaga);
}
...
export function* watchTransactions() {
  ...
  yield takeLatest(actionTypes.TRANSACTION_DELETE_REQUESTED, deleteTransactionsSaga);
}
